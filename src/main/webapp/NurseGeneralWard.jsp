    ...
    <form class="form1" action="addPatientServlet" method="post">
     <span class="close1" onclick="closeAddPatientModal()">&times;</span>
        ...
        List<Patient> patients = null;
            ...
            patients = patientDAO.getPatientswithGW();
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="GWdeletePatient.jsp?patientId=<%= patient.getPatientid() %>" style="color: red; align-item:center">Discharge</a></td>
            </tr>
            <%
                }
            %>
