...
<body>
    ...
    <a href="#" class="logo">
        ...
        <span class="nav-item">
            ...
            %>
				...
				<li>
				    <a href="addpatient1.jsp" >
				        <span class="nav-item">Add Patient</span>
				    </a>
				</li>                
				<li><a href="GCboxes.jsp" >
    ...
    <% 
        ...
        try {
            ...
            CardiologyDAO dao = new CardiologyDAO();
    ...
    <form class="form1" action="addPatientServlet" method="post">
     <span class="close1" onclick="closeAddPatientModal()">&times;</span>
        ...
        List<Patient> patients = null;
            ...
            patients = patientDAO.getPatientswithGC();
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="GCdeletePatient.jsp?patientId=<%= patient.getPatientid() %>" style="color: red; align-item:center">Discharge</a></td>
            </tr>
            <%
                }
            %>
