...
<section class="main-course">
    ...
    <div class="course-box">
        <form action="opBedBook" method="post">
            
            <div class="seat-container">
                <% List<Bed> acBeds = new ArrayList<>();
                try (Connection conn = DBUtil.getConnection();
                     PreparedStatement preparedStatement = conn.prepareStatement("SELECT * FROM orthopedicward WHERE type='AC'");
    ...
    <div class="course-box">
        <form action="opBedBook" method="post">
            ...
            <div class="seat-container">
                ...
                try (Connection conn = DBUtil.getConnection();
                     PreparedStatement preparedStatement = conn.prepareStatement("SELECT * FROM orthopedicward WHERE type='Non-ac'");
                     ResultSet resultSet = preparedStatement.executeQuery()) {
