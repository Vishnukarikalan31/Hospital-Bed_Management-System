...
<head>
  ...
  <title>Register as Nurse | Batch-11</title>
            ...
            <form action="registerServlet" method="post" onsubmit="return validateForm()">
                ...
                <div class="form-holder">
                    ...
                    <select class="form-control" name="department" id="department" required>
                        ...
                        <option value="Ortho Pedic Ward">Ortho Pedic Ward</option>
                ...
                <div class="form-holder">
                    <p>Already have an account?, click the link: <a href="login.jsp">Nurse Login!</a></p>
                </div>
            </form>
    ...
    <script>
            ...
            function validateForm() {
                ...
                if (!checkPasswordStrength(password)) {
                    alert('Password is weak. Make it stronger.');
                    return false; 
                } else {
                    return true; 
                }
