...
<style>
 ...
 <script>
        function toggleSeat(id, bedStatus, bedDetails) {
            ...
            document.getElementById("patientId").value = ""; // Clear input field
...
<section class="main-course">
    ...
    <div class="course-box">
        <form action="gwBedBook" method="post">
            
            <div class="seat-container">
                <% List<Bed> acBeds = new ArrayList<>();
                try (Connection conn = DBUtil.getConnection();
                     PreparedStatement preparedStatement = conn.prepareStatement("SELECT * FROM generalwardbed WHERE type='AC'");
    ...
    <div class="course-box">
        <form action="gwBedBook" method="post">
            ...
            <div class="seat-container">
                ...
                try (Connection conn = DBUtil.getConnection();
                     PreparedStatement preparedStatement = conn.prepareStatement("SELECT * FROM generalwardbed WHERE type='Non-ac'");
                     ResultSet resultSet = preparedStatement.executeQuery()) {
