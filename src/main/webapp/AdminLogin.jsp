...
<head>
  ...
  <title>Admin Login | Batch-11</title>
    ...
    .form-holder a:hover {
          ...
          <div class="inner">
            ...
            <form id="loginForm" onsubmit="return validateLogin()">
              ...
              <button type="submit" onclick="login()">
                ...
                <div class="form-holder"><p>If you're Nurse, click the link: <a href="login.jsp">Nurse Login</a></p></div>
            </form>
      ...
      document.getElementById('password').addEventListener('input', function () {
        ...
        function validateLogin() {
            ...
            if ((username === "Admin" && password === "Admin@123") || (username === "11111" && password === "Admin@123") ) {
