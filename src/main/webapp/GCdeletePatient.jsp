		...
		try {
            ...
            try {
             ...
             // Update the dischargedate column in the patient table based on patientId
                ...
                String deleteGeneralWardBedQuery = "UPDATE cardiologyward SET patientid = NULL WHERE patientid = ?";
                try (PreparedStatement bedStatement = con.prepareStatement(deleteGeneralWardBedQuery)) {
                    ...
                    if (bedRowsAffected > 0) {
                        ...
                        response.getWriter().write("<script> alert('Discharge Successful!'); window.location.replace('NurseCardiologyWard.jsp'); </script>");
                        return;
                    } else {
