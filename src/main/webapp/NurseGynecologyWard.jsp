    ...
    <a href="#" class="logo">
        ...
        <span class="nav-item">
            ...
            %>
                ...
                <li>
                    <a href="NurseGynecologyWard.jsp">
    ...
    <% 
        ...
        try {
            con = DBUtil.getConnection();
           	GynecologyDAO dao = new GynecologyDAO();
    ...
    <form class="form1" action="addPatientServlet" method="post">
     <span class="close1" onclick="closeAddPatientModal()">&times;</span>
        ...
        List<Patient> patients = null;
            ...
            patients = patientDAO.getPatientswithGN();
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="GndeletePatient.jsp?patientId=<%= patient.getPatientid() %>" style="color: red; align-item:center">Discharge</a></td>
            </tr>
            <%
                }
            %>
